...
public final class CCLFormater
{
  ...
  public CCLFormater(KernelData kd, int[] tile, File outFile, int[] stencil,Grammar g, Template template)
  {
    this.kd = kd;
    this.tile = tile;
  ...
  public String path_lower() { return template.abspath.replaceAll("\\$[^/]*$", "").replaceAll("/", "__"); }
  
  public String path_parent_lower() { return template.abspath.replaceAll("/[^/]*$","").replaceAll("/", "__"); }
